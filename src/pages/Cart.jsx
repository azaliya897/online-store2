  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.footer}>
        <p style={styles.total}>Итого: <b>${cartTotal.toFixed(2)}</b></p>
...
const styles = {
  ...
  row: { background: "white", border: "1px solid #e8e8e8", borderRadius: "12px", padding: "1rem", display: "flex", alignItems: "center", gap: "1rem" },
  ...
  removeBtn: { background: "#fff0f0", border: "none", borderRadius: "8px", padding: "8px 10px", color: "#ff4444", cursor: "pointer" },
  footer: { background: "white", border: "1px solid #e8e8e8", borderRadius: "12px", padding: "1.5rem", marginTop: "1rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" },
